...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/noobie.png'); ?>);">
...
<!-- <section class="ftco-section" id="products">
  ...
  <!-- <section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/noobie'); ?>);">
  <div class="container">
